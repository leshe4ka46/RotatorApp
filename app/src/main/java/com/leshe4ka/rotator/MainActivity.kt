...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //binding.editTextHomeLatitude.setText("56.409740")
        //binding.editTextHomeLongitude.setText("40.976156")
        //binding.editTextHomeHeight.setText("112")
        binding.sendAngles.setOnClickListener {
            post_angles(if(binding.editTextAzimuth.text.toString()!="") binding.editTextAzimuth.text.toString() else "-999",if(binding.editTextElevation.text.toString()!="") binding.editTextElevation.text.toString() else "-999",view)
        ...
        binding.sendSatPos.setOnClickListener {
            if(valid(binding.editTextSatLatitude.text) && valid(binding.editTextSatLongitude.text) && valid(binding.editTextSatHeight.text)){
                ...
                Snackbar.make(view,"Надо хоть что-то написать", Snackbar.LENGTH_LONG).setAction("Закрыть") {}
                    .show()
            }
        }
